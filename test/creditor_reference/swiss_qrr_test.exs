defmodule CreditorReference.SwissQRRTest do
  ...
  test "validates print formatted swiss QR-References" do
    assert CreditorReference.SwissQRR.valid?("21 00000 00003 13947 14300 09017") == true
    assert CreditorReference.SwissQRR.valid?("00 00082 07791 22585 74212 86694") == true
    assert CreditorReference.SwissQRR.valid?("00 00063 17171 24556 59592 26487") == true
  end

  test "validates digital formatted swiss QR-References" do
    assert CreditorReference.SwissQRR.valid?("210000000003139471430009017") == true
    assert CreditorReference.SwissQRR.valid?("000008207791225857421286694") == true
    assert CreditorReference.SwissQRR.valid?("000006317171245565959226487") == true
  end
  ...
  test "generates a valid reference" do
    ...
    assert CreditorReference.SwissQRR.valid?(ref) == true
  end
